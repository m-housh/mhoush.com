...
image: https://photos.housh.dev/share/YtKB1gkucw9o_IXeVNkuQn_K2sbWrKewvru9m9iQdC3HN0plGFSVxjMKHvNdBdJghjU
---

# Introduction to Programming for HVAC Part-4

This article builds upon our
[last](https://mhoush.com/posts/introduction-to-programming-for-hvac-3/) article, so make sure to
catch up before continuing with this article.
...
![greet-output](https://photos.housh.dev/share/gjrB5i5Q_7MWL2wS2FpUKyB0hWF4-tcodxeZPgW_3rJR5kZnoKhclB-YbiIT2oJDDsQ)

If you'd like to supply multiple words (or arguments that contain spaces) as a single argument then
...
> **Tip:** Wrapping in quotes is especially useful for commands that take file paths, if any of the
> folders or file names contain spaces.
...
![banner-transparent](https://photos.housh.dev/share/g9NiybQObFpiYhTaQUFBUDAEmjLJmImV4wCdzjxNPP-Q1mfL4Ey2skClWUE8M6CZ9H0)

> **Note:** If you are viewing this site in _light_ mode, the image does not look that bad. Hit the
